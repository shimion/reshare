...
function bp_reshare_add_reshare_button(){
	...
	if ( (isset( $_POST['scope'] ) && $_POST['scope'] == 'reshares') || bp_reshare_is_user_profile_reshares() || ( bp_is_activity_component() && !bp_displayed_user_id() && isset( $_COOKIE['bp-activity-scope'] ) && $_COOKIE['bp-activity-scope'] == 'reshares' ) ) {
		$extra_class = 'unshare';
	...
	<a href="<?php echo $action_url ?>" class="button bp-primary-action bp-agu-reshare" id="bp-agu-reshare-<?php bp_activity_id(); ?>" title="Swirl" rel="<?php echo $activity_first_id?>"><span class="bp-agu-reshare-img <?php echo $reshared_class .' '.$extra_class ;?>"></span><span class="rs-count"><?php echo $rs_count;?></span></a>
	<?php
